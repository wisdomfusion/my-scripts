...
# eg. ./deploy_static_react.sh -n "boss-web" -e prod -d "console.cn-healthcare.com" -h "172.17.212.193"
...
# 编译制品 rsync src
RSYNC_SRC="root@${RSYNC_HOST}::data/git_repos/${DEPLOY_ENV}frontend/${APP_NAME}/build/"
# 应用部署目录 rsync dest
